...
// Definitions by: SebastiÃ¡n Galiano <https://github.com/sgaliano>
...
export interface SwiperOptions {
 ...
 on?:
   | ({
       [key in Exclude<SwiperEvent, LazyLoadingEvent>]?: (
         this: SwiperInterface,
         swiper: SwiperInterface
       ) => void
     } & {
       [key in LazyLoadingEvent]?: (
         this: SwiperInterface,
         slideEl: HTMLElement,
...
export interface PaginationOptions {
  ...
  * });
  */
 renderCustom?: ((swiper: SwiperInterface, current: number, total: number) => void) | undefined
...
export interface ThumbsOptions {
 swiper?: SwiperInterface | undefined
...
export interface ControllerOptions {
  ...
  * by this Swiper
  */
 control?: SwiperInterface | undefined
...
export interface Controller {
  ...
  * by this Swiper
  */
 control?: SwiperInterface | SwiperInterface[] | undefined
}
...
*/
export interface EffectCoverflow {}
...
export interface SwiperInterface {
  ...
  */
 new (container: SelectableElement, options?: SwiperOptions): SwiperInterface
